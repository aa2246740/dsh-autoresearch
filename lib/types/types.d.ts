...
export declare const STATE_MARKER = "AUTORESEARCH_STATE_V1";
export declare const CONTINUE_MARKER = "AUTORESEARCH_CONTINUE";
export declare const CONTINUATION_REQUIRED = "AUTORESEARCH_CONTINUATION_REQUIRED";
/** Drop undefined keys and non-finite numbers so tool results pass harness JSON snapshotting. */
export declare function toJsonValue<T>(value: T): T;
/** Kept so old transcripts can still be parsed. New tool/command text must not use this. */
export declare function embedState(text: string, snapshot: AutoresearchSnapshot): string;
export declare function parseEmbeddedState(text: string): {
    text: string;
    snapshot?: AutoresearchSnapshot;
};
